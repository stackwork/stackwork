...
enum ModuleType {
   ...
   *
   * Builds an image that can be used in a Docker Compose setup (builder.docker-compose[.template]) during the build
   * phase of another project (that configures builderImageProject).
   */
  BUILDER_IMAGE,
